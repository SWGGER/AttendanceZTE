...
//        map.put("/css/**","anon");
//        map.put("/fontAlibaba/**","anon");
//        map.put("/fonts/**","anon");
//        map.put("/images/**","anon");
//        map.put("/img/**","anon");
//        map.put("/js/**","anon");
//
//        map.put("/login/getAllRole","anon");
//        map.put("/login/loginShiro","anon");
//        map.put("/psw/**","anon");
//        map.put("/tuser/**","anon");
//        //登出  加接口名  logout 权限验证不通过时，请求该接口   登录验证（用户名、密码不匹配）
//        map.put("/router/logout", "logout");
//        //对所有用户认证,authc:所有url都必须认证通过才可以访问; anon:所有url都都可以匿名访问
//        map.put("/**", "authc");
//
//        //登录    用户名、密码
//        shiroFilterFactoryBean.setLoginUrl("/router/index");
//
//        //首页    登录成功页面
